...
_DEPS=singleton.h gameManager.h windowManager.h IDamageable.h IPhysics.h IDrawable.h projectile.h entity.h
DEPS=$(patsubst %,$(IDIR)/%,$(_DEPS))
_OBJ=main.o singleton.o gameManager.o windowManager.o projectile.o entity.o
